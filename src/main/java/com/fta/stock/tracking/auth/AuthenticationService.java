...
import com.fta.stock.tracking.service.JwtService;
import com.fta.stock.tracking.exceptions.ApiRequestException;
import com.fta.stock.tracking.model.*;
import com.fta.stock.tracking.repository.TokenRepository;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    ...
    if (existingUser.isPresent()) {
      throw new ApiRequestException("E-mail address is already in use", HttpStatus.BAD_REQUEST);
    }
    ...
    settings.setEnableScheeduling(false);
